...
// ==== #187. Spring Scheduler(스프링 스케쥴러05) ==== //
...
public class GoogleMail {
	...
	public void sendemail_Reservation(String recipient, String emailContents) throws Exception { 
									// 받는이 			// 내용물
        ...
        prop.put("mail.smtp.user", "bdong5475@gmail.com");
        ...
        // 제목 설정
        String subject = "localhost:9090/board/ 방문예약일자를 알려드립니다.";
        msg.setSubject(subject);
                
        // 보내는 사람의 메일주소
        String sender = "bdong5475@gmail.com";
        ...
        // 메일 발송하기
        Transport.send(msg);
	} // end of	public public void sendemail_Reservation(String recipient, String emailContents)

	
	// 다중 첨부파일이 있는 메일 보내기 //
	public void sendemail_withFile(Map<String, Object> paraMap) throws Exception {
		// 1. 정보를 담기 위한 객체
		Properties prop = new Properties(); 
          	...
          	if(paraMap.get("arr_attachFilename") != null) {
                ...
                // 다음은 탐색기에서 C:\NCS\workspace_spring_framework\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\Board\resources\email_attach_file 에 생성된 파일을 불러온다. 
                 ...
                 // mimeType 종류를 알려주는 사이트 ==> https://developer.mozilla.org/ko/docs/Web/HTTP/Basics_of_HTTP/MIME_types/Common_types
          			Path path = Paths.get(attachFile.getCanonicalPath()); // import java.nio.file
	...
	}// end of public void sendemail_withFile(Map<String, Object> paraMap)
