...
public class TripboardDAO_imple implements TripboardDAO {
	...
	*/
	...
	public int add(TripboardVO tripboardvo) {
		...
		int n = sqlsession.insert("tripboard.add", tripboardvo);
	...
	public int add_withFile(TripboardVO tripboardvo) {
		...
		int n = sqlsession.insert("tripboard.add_withFile", tripboardvo);
		return n;
	}
	...
	public int getTotalCount(Map<String, String> paraMap) {
		int n = sqlsession.selectOne("tripboard.getTotalCount", paraMap);
		return n;
	}
	...
	public List<TripboardVO> tripboardListSearch_withPaging(Map<String, String> paraMap) {
		List<TripboardVO> tripboardList = sqlsession.selectList("tripboard.tripboardListSearch_withPaging", paraMap);
		return tripboardList;
	}

	@Override
	public TripboardVO getView(Map<String, String> paraMap) {
		TripboardVO tripboardvo = sqlsession.selectOne("tripboard.getView", paraMap); // 글1개 조회하기
		return tripboardvo;
	}

	@Override
	public int increase_readCount(String tb_seq) {
		int n = sqlsession.update("tripboard.increase_readCount", tb_seq);
		return n;
	}
	...
	public int getLike(Map<String, String> paraMap) {
		int n = sqlsession.insert("tripboard.getLike", paraMap);
		return n;
	}
	...
	public int deleteLike(Map<String, String> paraMap) {
		int n = sqlsession.insert("tripboard.deleteLike", paraMap);
		return n;
	}
	...
	public Map<String, Integer> getCnt(String tb_seq) {
		 Map<String, Integer> getCnt = sqlsession.selectOne("tripboard.getCnt", tb_seq);
		return getCnt;
	}
