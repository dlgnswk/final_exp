...
insert into tbl_checkin(self_checkin, self_checkin_content) values('0', '셀프체크인불가');
insert into tbl_checkin(self_checkin, self_checkin_content) values('1', '엑세스코드');
insert into tbl_checkin(self_checkin, self_checkin_content) values('2', '키 수령 안내');
insert into tbl_checkin(self_checkin, self_checkin_content) values('3', '록박스 이용 안내');
insert into tbl_checkin(self_checkin, self_checkin_content) values('4', '스마트 록 코드');
insert into tbl_checkin(self_checkin, self_checkin_content) values('5', '익스프레스 체크인');


-- 주차장 테이블
create table tbl_park
(park_type      Nvarchar2(1)    not null  -- 주차장타입 / 0,1,2
,park_content   Nvarchar2(4)    not null  -- 주차장내용 / 0:없음, 1:외부 주차장, 2:내부 주차장
...
,pool_content   Nvarchar2(5)   not null  -- 수영장종류내용 / 0:없음, 1:야외, 2:실내
...
-- 편의시설 테이블 tbl_facility fac_type
...
,lg_qty                 Nvarchar2(2)        not null            -- 객실수 / 20
