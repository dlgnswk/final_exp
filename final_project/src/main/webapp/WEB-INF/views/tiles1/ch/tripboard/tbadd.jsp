...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("button#btnWrite").click(function(){
			...
			frm.method = "post";
			frm.action = "<%= ctxPath%>/tbaddEnd.exp";
			frm.submit();
...
<div style="inline-size: 100%; margin: auto; max-inline-size: 85rem; padding: 50px 0;">
	...
	<div style="margin: auto; padding-left:3%;">
			...
			<h3 style="margin-bottom: 30px;">여행 후기 작성</h3>
	...
	<%-- === 파일 첨부하기 === 
	 ...
	 <form name="addFrm" enctype="multipart/form-data">
            ...
            <input type="hidden" name="tb_name" value="${sessionScope.loginuser.name}" readonly />   		
			
			
			<table style="width: 1024px ">      							
												
				<tr style="border-bottom: 0.0625rem solid #ddd;">
         			<th style="width: 15%; background-color: #f1f1f1;" size="100" maxlength="200"><span style="color:red;">* </span>제목</th>
         			<td>
							<input type="text" name="tb_subject" size="100" maxlength="200" placeholder="제목을 입력해주세요." autocomplete="off"/>   				
         			</td>
				</tr>
				<tr style="border-bottom: 0.0625rem solid #ddd;">
         			<th style="width: 15%; background-color: #f1f1f1;" size="100" maxlength="200"><span style="color:red;">* </span>지역</th>
         			<td>
							<input type="text" name="tb_city" size="33" maxlength="200" placeholder="지역 이름을 입력하세요. ex)서울, 부산"autocomplete="off"/>   				
         			</td>
				</tr>
				...
				<tr style="border-bottom: 0.0625rem solid #ddd;">
         			...
         			<td>
         				<textarea style="width:100%; height:300px;" name="tb_content" id="content" autocomplete="off"></textarea>
         			</td>
				</tr>
				
				<%-- === #150. 파일첨부 타입 추가하기 === --%>
				<tr style="border-bottom: 0.0625rem solid #ddd;">
         			<th style="width: 15%; background-color: #f1f1f1;">여행 일정</th>
         			<td>
