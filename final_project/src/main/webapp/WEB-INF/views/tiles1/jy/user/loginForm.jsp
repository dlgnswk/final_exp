...
<script>
	...
	function goLogin() {
		...
		if(val_pw == ""){
			$("div#err_msg_pw").show();
			$("input:password[name='pw']").addClass("com_invalid")
			$("div#err_msg_pw").html("<p style='color: red; font-size: 12px;'>비밀번호를 입력해주세요!</p>");
		}
	}
...
<div class="nav-top">
	...
	<div id="container" style="inline-size: 100%; margin: auto; max-inline-size: 75rem; padding: 50px 0;">
		<div class="login_section">
			<div><h2>로그인</h2></div>
			<form name="loginFrm">
			  <div class="" style="display:flex; flex-direction:column; gap: 0.75rem;">
				...
				<div class="uitk-field has-floatedLabel-label">
					<label for="pw" class="uitk-field-label is-visually-hidden">비밀번호</label>
					<input id="pw" type="password" name="pw" maxlength="60" class="uitk-field-input"
						placeholder="" aria-required="false" aria-invalid="false">
					<div class="uitk-field-label" aria-hidden="true">비밀번호</div>
				</div>
				<div class="err_msg" id="err_msg_pw"></div>
				<div style="margin: 1.5rem 0;"><a href="<%= ctxPath%>/login_regFrm.exp">비밀번호를 잊으셨나요?</a></div>
				<div class="continue c_btn_pri c_btn c_btn_lg">
