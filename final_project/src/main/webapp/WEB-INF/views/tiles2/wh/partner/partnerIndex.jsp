...
<script type="text/javascript">
	...
	function goHostControl() {
		const frm = document.useridSendFrm;
		frm.action  = "<%= ctxPath%>/partnerControl.exp";
		frm.method = "post";
		frm.submit();
	}
	...
	<div id="select_box" style="width:40%; margin: 0 auto;">
		...
		<div style="border: solid 0px gray; box-shadow:1px 3px 5px 1px gray; margin: 0; line-height: 18px; width: 100%; padding: 40px; border-radius: 1rem; margin-top: 2%;">
			...
			<div style="display:flex">
				<div onclick="goLodgeControl()" style="margin:5% auto; border: 2px solid #5252ff;  height: 200px; border-radius: 1rem; width:40%; margin-bottom: 25px; cursor:pointer; ">
				...
				<div onclick="goHostControl()" style="margin:5% auto; border: 2px solid #5252ff;  height: 200px; border-radius: 1rem; width:40%; margin-bottom: 25px; cursor:pointer;">
					<div style="width:50%; margin:10% auto;">
